...
export const Contact = ({ fullName, address, phone, email, id }) => {
    ...
    <div className="contact border row rounded d-flex p-2 ">
      ...
      <div className="contact__options d-flex col-md-2 col-2">
        ...
        <button
          ...
          data-bs-target={`#${fullName.replace(/\s/g, "")}`}
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              Do you want to remove {fullName} from your contacts?
            </div>
